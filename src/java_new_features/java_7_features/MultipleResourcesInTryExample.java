...
public class MultipleResourcesInTryExample 
{    
	public static void main(String args[])
	{      
		// Using try-with-resources  
		try(    // Using multiple resources  
				FileOutputStream fileOutputStream =new FileOutputStream("src/java_new_features/java_7_features/Files/Kanika.txt");  
				InputStream input = new FileInputStream("src/java_new_features/java_7_features/Files/Kanika.txt"))
		{  
			// -----------------------------Code to write data into file--------------------------------------------//  
			String msg = "Hey I am Kanika Aggarwal!";      
